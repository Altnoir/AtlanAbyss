...
//       name: '青春コンプレックス',
//       time: 203,
//       url: 'https://music.163.com/song/media/outer/url?id=2003496500.mp3'
//     },
//     {
//       id: 'netmusic:music_cd',
//       name: 'ひとりぼっち東京',
//       time: 232,
//       url: 'https://music.163.com/song/media/outer/url?id=2003496920.mp3'
//     },
//     {
//       id: 'netmusic:music_cd',
//       name: 'ギターと孤独と蒼い惑星',
...
//     return Item.of(item.id, 1).withNBT(`{NetMusicSongInfo:{name:"${item.name}",time:${item.time},url:"${item.url}"}}`).withChance(1.0 / items.length);
//   });
  
//   event.recipes.createCrushing(itemInputs, '#minecraft:music_discs')
//     .processingTime(50)
//     .id('llmion:crushing_netmusic_music_cd');
const musics = [
  {
